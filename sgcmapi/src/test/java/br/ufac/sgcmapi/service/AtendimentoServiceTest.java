...
public class AtendimentoServiceTest {
    ...
    void testAtendimentoGetTermoBusca() {
        Mockito.when(repo.busca("Limoeiro")).thenReturn(atendimentos);
        List<Atendimento> buscaResult = servico.get("Limoeiro");
        assertNotNull(buscaResult);
        assertEquals(2, buscaResult.size());
    }
